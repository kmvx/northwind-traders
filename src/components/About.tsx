...
const About: React.FC = () => {
  return (
    <div className="flex h-full flex-col bg-blue-950 text-[max(1.5rem,1vw)] sm:-m-2 xl:flex-row">
      ...
      <div className="flex flex-col justify-center text-white sm:p-[2vw] xl:w-2/5">
        ...
        <div className="m-2 text-gray-300">
          <p>
            ...
            <Button
              variant="link"
              asChild
              className="inline-flex h-auto items-center gap-1 p-0 text-[length:inherit] text-blue-400 has-[>svg]:px-0"
            >
              <a
